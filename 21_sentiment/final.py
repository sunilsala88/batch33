...
event_dates_data = pd.read_csv('/Users/algo trading 2025/batch33/21_sentiment/events.csv')
...
stock_prices_data = pd.read_csv('/Users/algo trading 2025/batch33/21_sentiment/AAPL_history.csv', index_col=0)
...
daily_sentiment_scores = pd.read_csv('/Users/algo trading 2025/batch33/21_sentiment/sentiment.csv', index_col=0)
...
print(stock_prices_data)
stock_prices_data.to_csv('sample.csv')
