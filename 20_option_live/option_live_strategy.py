...
expiry=(dt.now(time_zone) + dt.Duration(days=1)).date()
...
def store(data):
    pickle.dump(data, open(f'data-{dt.now(time_zone).date()}.pickle', 'wb'))
